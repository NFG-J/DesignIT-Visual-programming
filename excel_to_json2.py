...
# Load the Excel file
excel_file = 'C:/Users/nielsfgj/WebstormProjects/DesignIT_2.03/data/WebComponents (version 2025-01-09).xlsx'  # Update this to the file path
...
json_file_path = 'C:/Users/nielsfgj/WebstormProjects/DesignIT_2.03/data/components.json'  # Update this to desired output path
